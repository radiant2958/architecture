...
public abstract class Car {
    ...
    public void setCarWashService(CarWash carWashingService) {
        this.carWashingService = carWashingService;
    }

    public void washCar(CarWashType carWashType) {
        if (carWashingService != null) {
            carWashingService.wash(carWashType);
        } 
    }
    ...
    private CarWash carWashingService;
    ...
    public Car create(String string, String string2, Color red) {
        return null;
    }
